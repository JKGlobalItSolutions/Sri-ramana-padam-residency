    ...
    >
      <Card className="overflow-hidden hover:shadow-[0_10px_40px_-10px_hsl(var(--primary)/0.3)] transition-all duration-500 group">
        ...
        <div className="p-6">
          ...
          <Button className="w-full bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300 group-hover:shadow-[0_0_20px_hsl(var(--primary-glow)/0.5)]">
